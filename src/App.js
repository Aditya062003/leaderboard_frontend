...
function App() {
  ...
  useEffect(() => {
    fetch("https://leaderboard-u6es8ibj0-aditya062003.vercel.app/codeforces/")
      .then((res) => res.json())
      .then((res) => {
  ...
  useEffect(() => {
    fetch("https://leaderboard-u6es8ibj0-aditya062003.vercel.app/codechef/")
      .then((res) => res.json())
      .then((res) => {
  ...
  useEffect(() => {
    fetch("https://leaderboard-u6es8ibj0-aditya062003.vercel.app/leetcode/")
      .then((res) => res.json())
      .then((res) => {
  ...
  useEffect(() => {
    fetch("https://leaderboard-u6es8ibj0-aditya062003.vercel.app/openlake/")
      .then((res) => res.json())
      .then((res) => {
  ...
  useEffect(() => {
    fetch("https://leaderboard-u6es8ibj0-aditya062003.vercel.app/github/")
      .then((res) => res.json())
      .then((res) => {
        setGithubUser(res);
      });
