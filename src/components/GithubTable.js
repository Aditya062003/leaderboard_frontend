...
export const GithubTable = ({
  ...
  const getghfriends = async () => {
    const response = await fetch("https://leaderboard-ten-delta.vercel.app/api/getghfriends/",{mode:'cors'}, {
      method: "GET",
      headers: {
  ...
  async function addfriend(e) {
    ...
    const response = await fetch("https://leaderboard-ten-delta.vercel.app/api/ghfriends/",{mode:'cors'}, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization:
  ...
  async function dropfriend(e) {
    ...
    const response = await fetch("https://leaderboard-ten-delta.vercel.app/api/dropghfriends/", {mode:'cors'},{
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization:
