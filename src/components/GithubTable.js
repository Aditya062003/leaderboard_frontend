...
export const GithubTable = ({
  ...
  const getghfriends = async () => {
    const response = await fetch("https://leaderboard-ten-delta.vercel.app/api/getghfriends/", {
      method: "GET",
      headers: {
  ...
  async function addfriend(e) {
    ...
    const response = await fetch("https://leaderboard-ten-delta.vercel.app/api/ghfriends/", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization:
  ...
  async function dropfriend(e) {
    ...
    const response = await fetch("https://leaderboard-ten-delta.vercel.app/api/dropghfriends/", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization:
