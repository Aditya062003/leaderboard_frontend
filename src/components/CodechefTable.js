...
export const CodechefTable = ({
  ...
  const getccfriends = async () => {
    const response = await fetch("https://leaderboard-bjo0afk62-aditya062003.vercel.app/api/getccfriends/", {
      method: "GET",
      headers: {
  ...
  async function addfriend(e) {
    ...
    const response = await fetch("https://leaderboard-bjo0afk62-aditya062003.vercel.app/api/ccfriends/", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization:
  ...
  async function dropfriend(e) {
    ...
    const response = await fetch("https://leaderboard-bjo0afk62-aditya062003.vercel.app/api/dropccfriends/", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization:
